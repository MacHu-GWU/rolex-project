# -*- coding: utf-8 -*-
#
# rolex documentation build configuration file, created by
...
version = rolex.__version__
# The full version, including alpha/beta/rc tags.
release = rolex.__version__
...
html_logo = "./_static/rolex-logo.png"
html_favicon = "./_static/rolex-favicon.ico"
...
latex_documents = [
    (master_doc, 'rolex.tex', 'rolex Documentation',
     u'Sanhe Hu', 'manual'),
]
...
man_pages = [
    (master_doc, 'rolex', 'rolex Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'rolex', 'rolex Documentation',
     author, 'rolex', 'One line description of project.',
     'Miscellaneous'),
]
...
# Add data for Jinja2
try:
    from rolex.docs import doc_data
except:
    doc_data = dict()
